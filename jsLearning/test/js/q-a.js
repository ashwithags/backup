...
console.log(data);
  ...
  var qno=count+1;
      var Questdata='';
      Questdata +='<h5>Q'+qno+'. '+data[count].question+ '</h5>' + '<ul><li><input type="radio" class="" name="option"  value='+data[count].choices[0]+'>' + data[count].choices[0] + '</li><li><input type="radio" class="" name="option" value='+data[count].choices[1]+'>' + data[count].choices[1] + '</li><li><input type="radio" class="" name="option"  value='+data[count].choices[2]+'>' + data[count].choices[2] + '</li><li><input type="radio" class="" name="option" value='+data[count].choices[3]+'>' + data[count].choices[3] + '</li></ul>' + '<button class="btn btn-success chkBtn" onclick="checkAnswer();">Check Answer</button><button class="btn btn-primary nextBtn" onclick="next();">Next</button>' + '<hr>';
